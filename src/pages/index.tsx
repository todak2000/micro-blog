...
import { LandingPageHeader, Name, LandingPageText, initialArticlesObject, initialArticles, GoogleButtonText, GoogleLogo, AppGithubLink, PersonalGithubLink } from '@/constant'; 
