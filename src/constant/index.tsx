...
export const LandingPageText = "A simple blogging platform using Next.js, React, TypeScript, Redux, React Query, TailwindCss. The platform is user-friendly, and the code well-organized and documented.";
...
export const initialArticles = [
    { id: '1', title: 'First Article', content: `This blog page focuses the viewer on a three-column grid with buttons to encourage the visitor to click through to read the article. As the blog doesn’t use featured article sliders or images, the visitor can quickly see a number of articles that may interest them.
    ...
    { id: '2', title: 'Second Article', content: `This blog page focuses the viewer on a three-column grid with buttons to encourage the visitor to click through to read the article. As the blog doesn’t use featured article sliders or images, the visitor can quickly see a number of articles that may interest them.
